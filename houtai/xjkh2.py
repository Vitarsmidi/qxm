...
class TestKhgl(unittest.TestCase):
    def input_in(self):
        f = Faker('zh-cn')
        ...
        d.find_element_by_xpath(
            '//*[@id ="add-merchant-basic-info-form"]/fieldset[1]/div[1]/div[1]/div[1]/input').send_keys(name)
        sleep(0.5)
        ...
        for i in range(1):  # 循环执行次数
            ...
            finalController2 = get_element(d,
                                           (By.XPATH,
                                            '//*[@id="add-merchant-user-form"]/fieldset/div[11]/div[2]/div/select'))
        ...
        get_element(d, (By.XPATH, '//*[@id="approval-control-audit-form"]/fieldset/div[8]/div/input')).send_keys(
            f.words())
        sleep(1)
